          ...
          <div className='flex items-center gap-4'>
            {status === 'authenticated' ? (
              <>
                ...
                <button
                  onClick={() => signOut()}
                  className='hidden lg:block text-white bg-transparent border border-white hover:border-primary hover:text-primary duration-300 px-6 py-3 rounded-lg'>
                  Sign Out
                </button>
              </>
            ) : (
